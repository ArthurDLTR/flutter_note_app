            ...
            Align(
              ...
              child: RichText( // First, the title of the note in bold style and bigger
                text: TextSpan(
                  ...
                  style: TextStyle(fontWeight: FontWeight.bold, color: Color.fromARGB(255, 6, 6, 8))// fontSize: MediaQuery.of(context).size.width * 1.5 )
                ),
            ...
            Align(
              ...
              child: RichText( // Then, a preview of the note with the first lines
                text: TextSpan(
                  ...
                  style: TextStyle(fontWeight: FontWeight.w300, color: Color.fromARGB(255, 96, 96, 99)) // fontSize: MediaQuery.of(context).size.width * 0.5)
                ),
                textAlign: TextAlign.start,
              ),
            ),
